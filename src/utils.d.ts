...
export const emptyArr: readonly []

export function nop(): void

export function cached<T, R>(handler: (arg: T) => R): (arg: T) => R
export function cachedStrKeyNoFalsy<R>(handler: (key: string) => R): (key: string) => R

export function removeFromArr<T>(array: T[], value: T): void
